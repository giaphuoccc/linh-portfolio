const RoleSection = () => (
  <section className="flex flex-col items-center px-4 [font-family:'Inter_Display',sans-serif]">
    {/* Divider */}
    ...
    <div className="grid md:grid-cols-2 gap-10 items-center w-full max-w-4xl mx-auto">
      ...
      {/* Ảnh minh hoạ */}
      <img
        src="https://cdn.builder.io/api/v1/image/assets/4f495b6d81d24533a0f9f7f4a35d3038/715423c5781660d6c31efdeed20a7587c0e7d35e?placeholderIfAbsent=true"
