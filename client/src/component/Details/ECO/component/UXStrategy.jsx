const UXStrategy = () => (
  <section className="my-20">
    ...
    <div data-aos="fade-down" className="text-center max-w-3xl mx-auto">
      <p className="uppercase tracking-widest text-xs font-medium text-gray-500 mb-2">
        4. Design
      </p>

      <h2 className="font-semibold text-2xl md:text-3xl mb-4 leading-snug">
        Time is not on our side <br className="hidden md:block" />
        – only speed matters
      </h2>

      <p className="text-gray-700 text-sm md:text-base leading-relaxed max-w-lg mx-auto">
    ...
    <figure className="my-12" data-aos="fade-down">
    ...
    <div className="grid md:grid-cols-3 gap-8" data-aos="fade-down">
      {/* Problem */}
      <div>
        <h3 className="font-semibold text-lg mb-4">Problem</h3>
      ...
      {/* Payoff */}
      <div>
        <h3 className="font-semibold text-lg mb-4">Payoff</h3>
        <ul className="space-y-4 text-sm leading-relaxed text-gray-700">
          <li>
    ...
    {/* ----------  UX STRATEGY CARD  ---------- */}
    <div
      className="bg-[#F5F5F5] px-8 py-12 mt-16 rounded-lg"
      data-aos="fade-down"
    >
      <h2 className="text-center font-semibold text-2xl md:text-3xl mb-2">
        UX Strategy
      </h2>
      <h3 className="text-center text-xl md:text-2xl font-medium mb-6">
        Don’t reinvent&nbsp;the&nbsp;wheel
      </h3>

      <p className="text-gray-700 text-sm md:text-base leading-relaxed max-w-3xl mx-auto mb-4">
      ...
      <ul className="list-disc pl-6 text-gray-700 text-sm md:text-base leading-relaxed max-w-3xl mx-auto space-y-1">
      ...
      <p className="text-gray-700 text-sm md:text-base leading-relaxed max-w-3xl mx-auto mt-6">
