  ...
  return (
    <>
      {projects.map((project, index) => (
        <div key={index} className="flex flex-col mt-20 w-full text-xl font-semibold tracking-wider leading-snug text-orange-200 uppercase max-md:mt-10 max-md:mr-1 max-md:max-w-full">
          <img
            loading="lazy"
            src={project.image}
            className="object-contain w-full rounded-2xl aspect-[2.13] max-md:max-w-full"
