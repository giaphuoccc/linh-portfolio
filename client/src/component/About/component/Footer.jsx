function Footer() {
  return (
    <>
      ...
      <div className="flex flex-wrap justify-between items-center mt-32 text-xl font-semibold tracking-wider leading-snug text-black whitespace-nowrap max-md:mt-10 max-md:mr-0.5">
